...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>graphgenerator</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class GraphgeneratorExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(GraphgeneratorPackage.eNS_URI, 
			 GraphgeneratorPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.graphgenerator")); //$NON-NLS-1$
				SquareGraphLatticeGenerator root = GraphgeneratorFactory.eINSTANCE.createSquareGraphLatticeGenerator();

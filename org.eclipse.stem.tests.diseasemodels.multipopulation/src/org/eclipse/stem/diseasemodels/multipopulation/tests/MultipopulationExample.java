...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>multipopulation</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class MultipopulationExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(MultipopulationPackage.eNS_URI, 
			 MultipopulationPackage.eINSTANCE);

...
/*
 */
public class VectorPopulationEnumeratorAdapterFactory extends
		VectorAdapterFactory implements PopulationEnumeratorAdapterFactory {
	 ...
	 * Constructor
	 */
	public VectorPopulationEnumeratorAdapterFactory() {
		super();
	...
	public Adapter createMacdonaldRossDiseaseModelAdapter() {
		return new VectorPopulationEnumeratorAdapter();
	} 

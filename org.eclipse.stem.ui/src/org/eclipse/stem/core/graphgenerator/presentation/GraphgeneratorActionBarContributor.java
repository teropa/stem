...
/**
 * This is the action bar contributor for the Graphgenerator model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GraphgeneratorActionBarContributor
	 ...
	 * @generated
	 */
	public GraphgeneratorActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("graphgenerator-settings")); //$NON-NLS-1$
		toolBarManager.add(new Separator("graphgenerator-additions")); //$NON-NLS-1$
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(CoreEditorPlugin.INSTANCE.getString("_UI_GraphgeneratorEditor_menu"), "org.eclipse.stem.core.graphgeneratorMenuID"); //$NON-NLS-1$ //$NON-NLS-2$

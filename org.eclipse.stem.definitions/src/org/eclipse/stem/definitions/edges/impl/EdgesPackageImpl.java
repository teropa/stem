...
public class EdgesPackageImpl extends EPackageImpl implements EdgesPackage {
	...
	public static EdgesPackage init() {
		...
		EdgesPackageImpl theEdgesPackage = (EdgesPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof EdgesPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new EdgesPackageImpl());

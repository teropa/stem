...
/**
 * This is the item provider adapter for a {@link org.eclipse.stem.definitions.edges.PopulationEdge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PopulationEdgeItemProvider
	 ...
	 * @generated
	 */
	public PopulationEdgeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PopulationEdge_populationIdentifier_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_PopulationEdge_populationIdentifier_feature", "_UI_PopulationEdge_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 EdgesPackage.Literals.POPULATION_EDGE__POPULATION_IDENTIFIER,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns PopulationEdge.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PopulationEdge")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		URI labelValue = ((PopulationEdge)object).getURI();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_PopulationEdge_type") : //$NON-NLS-1$
			getString("_UI_PopulationEdge_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PopulationEdge.class)) {

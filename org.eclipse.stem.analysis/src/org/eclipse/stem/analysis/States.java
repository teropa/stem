...
public class States {
     ...
     */
	public static final String[] statesToFit= {"S","E","I","R","IR","IF"};
	/**
	 ...
	 */
	public static final int INFECTIOUS_RECOVER = 4;
	/**
	 *  Infectious died index (for statesToFit)
	 */
	public static final int INFECTIOUS_DIE     = 5;
}

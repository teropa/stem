...
public class PredicatePackageImpl extends EPackageImpl implements PredicatePackage {
	...
	public static PredicatePackage init() {
		...
		PredicatePackageImpl thePredicatePackage = (PredicatePackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof PredicatePackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new PredicatePackageImpl());

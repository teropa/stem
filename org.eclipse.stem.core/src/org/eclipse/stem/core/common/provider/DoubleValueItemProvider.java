...
public class DoubleValueItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DoubleValue")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((DoubleValue)object).getIdentifier();
		return label == null || label.length() == 0 ?
			getString("_UI_DoubleValue_type") : //$NON-NLS-1$
			getString("_UI_DoubleValue_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}

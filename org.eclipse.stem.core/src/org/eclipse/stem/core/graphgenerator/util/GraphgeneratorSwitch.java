 ...
 * @generated
 */
public class GraphgeneratorSwitch<T1> {
	/**
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case GraphgeneratorPackage.GRAPH_GENERATOR: {
			...
			case GraphgeneratorPackage.LATTICE_GRAPH_GENERATOR: {
			...
			case GraphgeneratorPackage.SQUARE_GRAPH_LATTICE_GENERATOR: {
				SquareGraphLatticeGenerator squareGraphLatticeGenerator = (SquareGraphLatticeGenerator)theEObject;
				T1 result = caseSquareGraphLatticeGenerator(squareGraphLatticeGenerator);
				if (result == null) result = caseLatticeGraphGenerator(squareGraphLatticeGenerator);
				if (result == null) result = caseGraphGenerator(squareGraphLatticeGenerator);
				if (result == null) result = caseIdentifiable(squareGraphLatticeGenerator);
				if (result == null) result = caseComparable(squareGraphLatticeGenerator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Square Graph Lattice Generator</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Square Graph Lattice Generator</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T1 caseSquareGraphLatticeGenerator(SquareGraphLatticeGenerator object) {
		return null;
	}

...
public class SequencerPackageImpl extends EPackageImpl implements SequencerPackage {
	...
	public static SequencerPackage init() {
		...
		SequencerPackageImpl theSequencerPackage = (SequencerPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof SequencerPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new SequencerPackageImpl());

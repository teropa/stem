...
public class URIToEdgeMapEntryImpl extends CDOObjectImpl implements BasicEMap.Entry<URI,Edge> {
	...
	public URI getTypedKey() {
		return (URI)eDynamicGet(GraphPackage.URI_TO_EDGE_MAP_ENTRY__KEY, GraphPackage.Literals.URI_TO_EDGE_MAP_ENTRY__KEY, true, true);
	}
	...
	public void setTypedKey(URI newKey) {
		eDynamicSet(GraphPackage.URI_TO_EDGE_MAP_ENTRY__KEY, GraphPackage.Literals.URI_TO_EDGE_MAP_ENTRY__KEY, newKey);
	}
	...
	public Edge getTypedValue() {
		return (Edge)eDynamicGet(GraphPackage.URI_TO_EDGE_MAP_ENTRY__VALUE, GraphPackage.Literals.URI_TO_EDGE_MAP_ENTRY__VALUE, true, true);
	}
	...
	public NotificationChain basicSetTypedValue(Edge newValue, NotificationChain msgs) {
		msgs = eDynamicInverseAdd((InternalEObject)newValue, GraphPackage.URI_TO_EDGE_MAP_ENTRY__VALUE, msgs);
		return msgs;
	}
	...
	public void setTypedValue(Edge newValue) {
		eDynamicSet(GraphPackage.URI_TO_EDGE_MAP_ENTRY__VALUE, GraphPackage.Literals.URI_TO_EDGE_MAP_ENTRY__VALUE, newValue);
	}

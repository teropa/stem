...
public class URIToNodeMapEntryImpl extends EObjectImpl implements BasicEMap.Entry<URI,Node> {
	...
	public URI getTypedKey() {
		return (URI)eDynamicGet(GraphPackage.URI_TO_NODE_MAP_ENTRY__KEY, GraphPackage.Literals.URI_TO_NODE_MAP_ENTRY__KEY, true, true);
	}
	...
	public void setTypedKey(URI newKey) {
		eDynamicSet(GraphPackage.URI_TO_NODE_MAP_ENTRY__KEY, GraphPackage.Literals.URI_TO_NODE_MAP_ENTRY__KEY, newKey);
	}
	...
	public Node getTypedValue() {
		return (Node)eDynamicGet(GraphPackage.URI_TO_NODE_MAP_ENTRY__VALUE, GraphPackage.Literals.URI_TO_NODE_MAP_ENTRY__VALUE, true, true);
	}
	...
	public NotificationChain basicSetTypedValue(Node newValue, NotificationChain msgs) {
		msgs = eDynamicInverseAdd((InternalEObject)newValue, GraphPackage.URI_TO_NODE_MAP_ENTRY__VALUE, msgs);
		return msgs;
	}
	...
	public void setTypedValue(Node newValue) {
		eDynamicSet(GraphPackage.URI_TO_NODE_MAP_ENTRY__VALUE, GraphPackage.Literals.URI_TO_NODE_MAP_ENTRY__VALUE, newValue);
	}

 ...
 * @generated
 */
public class URIToLabelMapEntryImpl extends CDOObjectImpl implements BasicEMap.Entry<URI,Label> {
	/**
	...
	public URI getTypedKey() {
		return (URI)eDynamicGet(GraphPackage.URI_TO_LABEL_MAP_ENTRY__KEY, GraphPackage.Literals.URI_TO_LABEL_MAP_ENTRY__KEY, true, true);
	}
	...
	public void setTypedKey(URI newKey) {
		eDynamicSet(GraphPackage.URI_TO_LABEL_MAP_ENTRY__KEY, GraphPackage.Literals.URI_TO_LABEL_MAP_ENTRY__KEY, newKey);
	}
	...
	public Label getTypedValue() {
		return (Label)eDynamicGet(GraphPackage.URI_TO_LABEL_MAP_ENTRY__VALUE, GraphPackage.Literals.URI_TO_LABEL_MAP_ENTRY__VALUE, true, true);
	}
	...
	public NotificationChain basicSetTypedValue(Label newValue, NotificationChain msgs) {
		msgs = eDynamicInverseAdd((InternalEObject)newValue, GraphPackage.URI_TO_LABEL_MAP_ENTRY__VALUE, msgs);
		return msgs;
	}
	...
	public void setTypedValue(Label newValue) {
		eDynamicSet(GraphPackage.URI_TO_LABEL_MAP_ENTRY__VALUE, GraphPackage.Literals.URI_TO_LABEL_MAP_ENTRY__VALUE, newValue);
	}

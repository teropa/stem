...
public class TriggerPackageImpl extends EPackageImpl implements TriggerPackage {
	...
	public static TriggerPackage init() {
		...
		TriggerPackageImpl theTriggerPackage = (TriggerPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof TriggerPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new TriggerPackageImpl());

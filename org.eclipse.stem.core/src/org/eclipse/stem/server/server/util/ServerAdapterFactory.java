...
public class ServerAdapterFactory extends AdapterFactoryImpl {
	...
	protected ServerSwitch<Adapter> modelSwitch =
		new ServerSwitch<Adapter>() {
			@Override
			public Adapter caseSimulations(Simulations object) {
				return createSimulationsAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.stem.server.server.Simulations <em>Simulations</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSimulationsAdapter() {
		return null;
	}

...
public class GeneratedpluginPackageImpl extends EPackageImpl implements
	...
	public static GeneratedpluginPackage init() {
		if (isInited)
			return (GeneratedpluginPackage) EPackage.Registry.INSTANCE
					.getEPackage(GeneratedpluginPackage.eNS_URI);

		// Obtain or create and register package
		GeneratedpluginPackageImpl theGeneratedpluginPackage = (GeneratedpluginPackageImpl) (EPackage.Registry.INSTANCE
				.getEPackage(eNS_URI) instanceof GeneratedpluginPackageImpl ? EPackage.Registry.INSTANCE
				.getEPackage(eNS_URI)
				: new GeneratedpluginPackageImpl());
	...
	public void initializePackageContents() {
		...
		initEClass(dublinCoreEClass, DublinCore.class, "DublinCore",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getDublinCore_BibliographicCitation(), theXMLTypePackage
				.getString(), "bibliographicCitation", null, 0, 1,
				DublinCore.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDublinCore_CategoryId(), theXMLTypePackage
				.getString(), "categoryId", null, 1, 1, DublinCore.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDublinCore_Contributor(), theXMLTypePackage
				.getString(), "contributor", null, 0, 1, DublinCore.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDublinCore_Coverage(), theXMLTypePackage.getString(),
				"coverage", null, 0, 1, DublinCore.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getDublinCore_Created(), theXMLTypePackage.getString(),
				"created", null, 0, 1, DublinCore.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getDublinCore_Creator(), theXMLTypePackage.getString(),
				"creator", null, 0, 1, DublinCore.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getDublinCore_Date(), theXMLTypePackage.getString(),
				"date", null, 0, 1, DublinCore.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getDublinCore_Description(), theXMLTypePackage
				.getString(), "description", null, 0, 1, DublinCore.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDublinCore_Format(), theXMLTypePackage.getString(),
				"format", null, 0, 1, DublinCore.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getDublinCore_Identifier(), theXMLTypePackage
				.getString(), "identifier", null, 1, 1, DublinCore.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDublinCore_Language(), theXMLTypePackage.getString(),
				"language", null, 0, 1, DublinCore.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getDublinCore_License(), theXMLTypePackage.getString(),
				"license", null, 0, 1, DublinCore.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getDublinCore_Publisher(),
				theXMLTypePackage.getString(), "publisher", null, 0, 1,
				DublinCore.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDublinCore_Relation(), theXMLTypePackage.getString(),
				"relation", null, 0, 1, DublinCore.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getDublinCore_Requires(), theXMLTypePackage.getString(),
				"requires", null, 0, 1, DublinCore.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getDublinCore_Rights(), theXMLTypePackage.getString(),
				"rights", null, 0, 1, DublinCore.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getDublinCore_Source(), theXMLTypePackage.getString(),
				"source", null, 0, 1, DublinCore.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getDublinCore_Spatial(), theXMLTypePackage.getString(),
				"spatial", null, 0, 1, DublinCore.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getDublinCore_Subject(), theXMLTypePackage.getString(),
				"subject", null, 0, 1, DublinCore.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getDublinCore_Title(), theXMLTypePackage.getString(),
				"title", null, 1, 1, DublinCore.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getDublinCore_Type(), theXMLTypePackage.getString(),
				"type", null, 0, 1, DublinCore.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getDublinCore_Valid(), theXMLTypePackage.getString(),
				"valid", null, 0, 1, DublinCore.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(extensionEClass, Extension.class, "Extension", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getExtension_Categories(), this.getStemCategory(), null,
				"categories", null, 1, -1, Extension.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getExtension_DublinCores(), this.getDublinCore(), null,
				"dublinCores", null, 0, -1, Extension.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getExtension_Point(), theXMLTypePackage.getString(),
				"point", null, 1, 1, Extension.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(pluginEClass, Plugin.class, "Plugin", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPlugin_Extensionelement(), this.getExtension(), null,
				"extensionelement", null, 0, -1, Plugin.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(stemCategoryEClass, StemCategory.class, "StemCategory",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getStemCategory_Id(), theXMLTypePackage.getString(),
				"id", null, 1, 1, StemCategory.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getStemCategory_Name(), theXMLTypePackage.getString(),
				"name", null, 1, 1, StemCategory.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getStemCategory_ParentId(), theXMLTypePackage
				.getString(), "parentId", null, 1, 1, StemCategory.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation(dublinCoreEClass, source, new String[] { "name",
				"dublin_core", "kind", "empty" });
		addAnnotation(getDublinCore_BibliographicCitation(), source,
				new String[] { "kind", "attribute", "name",
						"bibliographicCitation" });
		addAnnotation(getDublinCore_CategoryId(), source, new String[] {
				"kind", "attribute", "name", "category_id" });
		addAnnotation(getDublinCore_Contributor(), source, new String[] {
				"kind", "attribute", "name", "contributor" });
		addAnnotation(getDublinCore_Coverage(), source, new String[] { "kind",
				"attribute", "name", "coverage" });
		addAnnotation(getDublinCore_Created(), source, new String[] { "kind",
				"attribute", "name", "created" });
		addAnnotation(getDublinCore_Creator(), source, new String[] { "kind",
				"attribute", "name", "creator" });
		addAnnotation(getDublinCore_Date(), source, new String[] { "kind",
				"attribute", "name", "date" });
		addAnnotation(getDublinCore_Description(), source, new String[] {
				"kind", "attribute", "name", "description" });
		addAnnotation(getDublinCore_Format(), source, new String[] { "kind",
				"attribute", "name", "format" });
		addAnnotation(getDublinCore_Identifier(), source, new String[] {
				"kind", "attribute", "name", "identifier" });
		addAnnotation(getDublinCore_Language(), source, new String[] { "kind",
				"attribute", "name", "language" });
		addAnnotation(getDublinCore_License(), source, new String[] { "kind",
				"attribute", "name", "license" });
		addAnnotation(getDublinCore_Publisher(), source, new String[] { "kind",
				"attribute", "name", "publisher" });
		addAnnotation(getDublinCore_Relation(), source, new String[] { "kind",
				"attribute", "name", "relation" });
		addAnnotation(getDublinCore_Requires(), source, new String[] { "kind",
				"attribute", "name", "requires" });
		addAnnotation(getDublinCore_Rights(), source, new String[] { "kind",
				"attribute", "name", "rights" });
		addAnnotation(getDublinCore_Source(), source, new String[] { "kind",
				"attribute", "name", "source" });
		addAnnotation(getDublinCore_Spatial(), source, new String[] { "kind",
				"attribute", "name", "spatial" });
		addAnnotation(getDublinCore_Subject(), source, new String[] { "kind",
				"attribute", "name", "subject" });
		addAnnotation(getDublinCore_Title(), source, new String[] { "kind",
				"attribute", "name", "title" });
		addAnnotation(getDublinCore_Type(), source, new String[] { "kind",
				"attribute", "name", "type" });
		addAnnotation(getDublinCore_Valid(), source, new String[] { "kind",
				"attribute", "name", "valid" });
		addAnnotation(extensionEClass, source, new String[] { "name",
				"extension", "kind", "elementOnly" });
		addAnnotation(getExtension_Categories(), source, new String[] { "kind",
				"element", "name", "categories", "namespace",
				"##targetNamespace" });
		addAnnotation(getExtension_DublinCores(), source, new String[] {
				"kind", "element", "name", "dublinCores", "namespace",
				"##targetNamespace" });
		addAnnotation(getExtension_Point(), source, new String[] { "kind",
				"attribute", "name", "point" });
		addAnnotation(pluginEClass, source, new String[] { "name", "plugin",
				"kind", "elementOnly" });
		addAnnotation(getPlugin_Extensionelement(), source, new String[] {
				"kind", "element", "name", "extensionelement", "namespace",
				"##targetNamespace" });
		addAnnotation(stemCategoryEClass, source, new String[] { "name",
				"stem_category", "kind", "empty" });
		addAnnotation(getStemCategory_Id(), source, new String[] { "kind",
				"attribute", "name", "id" });
		addAnnotation(getStemCategory_Name(), source, new String[] { "kind",
				"attribute", "name", "name" });
		addAnnotation(getStemCategory_ParentId(), source, new String[] {
				"kind", "attribute", "name", "parent_id" });
	}

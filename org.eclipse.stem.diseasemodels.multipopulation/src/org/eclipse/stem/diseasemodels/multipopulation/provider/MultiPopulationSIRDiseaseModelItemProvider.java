...
/**
 * This is the item provider adapter for a {@link org.eclipse.stem.diseasemodels.multipopulation.MultiPopulationSIRDiseaseModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MultiPopulationSIRDiseaseModelItemProvider
	extends MultiPopulationSIDiseaseModelItemProvider
	implements
	 ...
	 * @generated
	 */
	public MultiPopulationSIRDiseaseModelItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MultiPopulationSIRDiseaseModel_immunityLossRate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MultiPopulationSIRDiseaseModel_immunityLossRate_feature", "_UI_MultiPopulationSIRDiseaseModel_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MultipopulationPackage.Literals.MULTI_POPULATION_SIR_DISEASE_MODEL__IMMUNITY_LOSS_RATE);
		}
	...
	/**
	 * This returns MultiPopulationSIRDiseaseModel.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated NOT
	 */
	...
	public String getText(Object object) {
		String label = ((MultiPopulationSIRDiseaseModel)object).getURI().lastSegment();
		return label == null || label.length() == 0 ?
			getString("_UI_MultiPopulationSIRDiseaseModel_type") :
			label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MultiPopulationSIRDiseaseModel.class)) {

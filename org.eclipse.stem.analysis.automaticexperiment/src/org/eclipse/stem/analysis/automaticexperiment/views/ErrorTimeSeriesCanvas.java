...
/**
 * ErrorTimeSeriesCanvas is a subclass of {@link Canvas} suitable for chart drawings.
 */
public class ErrorTimeSeriesCanvas extends Canvas {
	 ...
	 */
	public ErrorTimeSeriesCanvas(final AnalysisControl analysisControl, final Composite parent, 
	 ...
	 *  
	 */
	public ErrorTimeSeriesCanvas(final Composite parent, 
			final String ordinateString, 
			final String yAxisLabel, 
			final String xAxisLabel,
			final String firstProperty,
	...
	/**
	 * The method which gets the {@link ErrorTimeSeriesCanvas}' reports list, and
	 * draws it on the {@link ErrorTimeSeriesCanvas}.
	...
	public final Chart createSimpleLineChart(
		...
		if(!dataSeriesMap.containsKey(firstProperty)) {
			DataSeries series = new DataSeries(Messages.getString("AUTO.TITLE2"), 0, overlayMode);

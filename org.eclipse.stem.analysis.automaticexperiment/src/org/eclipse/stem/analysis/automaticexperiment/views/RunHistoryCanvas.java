...
/**
 * RunHistoryCanvas is a subclass of {@link Canvas} suitable for chart drawings.
 */
public class RunHistoryCanvas extends Canvas {
	...
	/**
	 * Keep track of which RunHistory are visible
	 */
	 ...
	 */
	public RunHistoryCanvas(final AnalysisControl analysisControl, final Composite parent, 
	 ...
	 *  
	 */
	public RunHistoryCanvas(final Composite parent, 
			final String ordinateString, 
			final String yAxisLabel, 
			final String xAxisLabel,
			final String firstProperty,
	...
	/**
	 * The method which gets the {@link RunHistoryCanvas}' reports list, and
	 * draws it on the {@link RunHistoryCanvas}.
